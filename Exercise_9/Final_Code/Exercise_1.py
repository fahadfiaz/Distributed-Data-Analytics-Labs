...
############tensorboard#########################
np_to_tn=torch.from_numpy(olivetti.images)
img_grid = torchvision.utils.make_grid(np_to_tn[0])
writer.add_image('olivetti_images_sample', img_grid)
############tensorboard#########################
...
#to count model trainable paramters
